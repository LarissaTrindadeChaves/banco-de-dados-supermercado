...
insert into
    colaborador (nome, cargo, telefone, data_admissao, salario, cpf)
values
...
insert into
    fornecedores (nome, telefone, cnpj)
values
...
insert into
    venda (valor_total, id_cliente, id_colaborador)
values
    (50.80, 1, 1),
    (30.00, 2, 2),
    (15.70, 3, 3),
...
insert into
    pagamento (forma_pagamento, valor, id_venda)
values
...
insert into
    devolucao (data_devolucao, motivo, id_venda)
values
    ('2025-02-20', 'Produto com defeito', 2),
    ('2025-02-25', 'Cliente desistiu da compra', 4);

insert into
    produto (nome, codigo_produto, categoria, estoque, preco, id_fornecedores)
values
...
insert into
    itens_venda (qtde, preco_unitario, id_venda, id_produto)
values
    (2, 25.90, 1, 1), 
    (1, 9.99, 2, 3),  
    (2, 6.90, 3, 5),  
...
insert into
    produtos_promocoes (desconto, id_produto, id_promocao)
values
    (10.00, 1, 1), -- 10% de desconto no arroz
    (5.00, 3, 1),  -- 5% de desconto na Coca-Cola
    (15.00, 4, 2); -- 15% de desconto na barra de chocolate
